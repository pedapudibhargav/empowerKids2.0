$( document ).ready(function(){
   ...
   var memberDetails = [
     ...
     "Puja is an HR Professional and enjoys to volunteer in meaningful non-profit organizations. Empowering underprivileged children through education is Puja's passion. She will be helping on opportunities to spread our initiatives and goals to help raise funds, and donations to help our children gain scholarships and tuition.Her deep interest and concern for meaningful causes, span from heading and participating as a team lead for fund raising for organizations such as Autism Speaks, American Cancer Society etc.  Puja comes with a Bachelor Degree from Les Roches, Siwtzlernd in International Hospitality Management."
   ]
